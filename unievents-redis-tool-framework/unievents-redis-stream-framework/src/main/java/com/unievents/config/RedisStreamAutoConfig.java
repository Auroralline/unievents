...
import com.unievents.MessageConsumer;
import com.unievents.RedisStreamConfigProperties;
import com.unievents.RedisStreamHandler;
import com.unievents.RedisStreamListener;
import com.unievents.RedisStreamPushHandler;
import com.unievents.constant.RedisStreamConstant;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new unieventsFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}
