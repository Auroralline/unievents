...
import com.unievents.dto.SeatAddDto;
import com.unievents.dto.SeatBatchAddDto;
import com.unievents.dto.SeatBatchRelateInfoAddDto;
import com.unievents.dto.SeatListDto;
...
import com.unievents.enums.SeatType;
...
import com.unievents.service.lua.ProgramSeatCacheData;
...
import com.unievents.vo.SeatRelateInfoVo;
...
import static com.unievents.core.DistributedLockConstants.GET_SEAT_LOCK;
import static com.unievents.core.DistributedLockConstants.SEAT_LOCK;
...
public class SeatService extends ServiceImpl<SeatMapper, Seat> {
    ...
    public Long add(SeatAddDto seatAddDto) {
        ...
        if (Objects.nonNull(seat)) {
            throw new unieventsFrameException(BaseCode.SEAT_IS_EXIST);
        }
        seat = new Seat();
