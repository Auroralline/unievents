...
import com.unievents.dto.UserAuthenticationDto;
import com.unievents.dto.UserExistDto;
import com.unievents.dto.UserGetAndTicketUserListDto;
import com.unievents.dto.UserIdDto;
import com.unievents.dto.UserLoginDto;
import com.unievents.dto.UserLogoutDto;
import com.unievents.dto.UserMobileDto;
import com.unievents.dto.UserRegisterDto;
import com.unievents.dto.UserUpdateDto;
import com.unievents.dto.UserUpdateEmailDto;
import com.unievents.dto.UserUpdateMobileDto;
import com.unievents.dto.UserUpdatePasswordDto;
import com.unievents.entity.TicketUser;
import com.unievents.entity.User;
import com.unievents.entity.UserEmail;
import com.unievents.entity.UserMobile;
...
import com.unievents.mapper.TicketUserMapper;
import com.unievents.mapper.UserEmailMapper;
import com.unievents.mapper.UserMapper;
import com.unievents.mapper.UserMobileMapper;
...
import com.unievents.vo.UserLoginVo;
...
import static com.unievents.core.DistributedLockConstants.REGISTER_USER_LOCK;
...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public void doExist(String mobile){
        ...
        if (contains) {
            ...
            if (Objects.nonNull(userMobile)) {
                throw new unieventsFrameException(BaseCode.USER_EXIST);
            }
        }
    }
    ...
    public UserLoginVo login(UserLoginDto userLoginDto) {
        ...
        if (StringUtil.isEmpty(mobile) && StringUtil.isEmpty(email)) {
            throw new unieventsFrameException(BaseCode.USER_MOBILE_AND_EMAIL_NOT_EXIST);
        }
        Long userId;
        if (StringUtil.isNotEmpty(mobile)) {
            ...
            if (StringUtil.isNotEmpty(errorCountStr) && Integer.parseInt(errorCountStr) >= ERROR_COUNT_THRESHOLD) {
                throw new unieventsFrameException(BaseCode.MOBILE_ERROR_COUNT_TOO_MANY);
            }
            LambdaQueryWrapper<UserMobile> queryWrapper = Wrappers.lambdaQuery(UserMobile.class)
                    .eq(UserMobile::getMobile, mobile);
            UserMobile userMobile = userMobileMapper.selectOne(queryWrapper);
            if (Objects.isNull(userMobile)) {
                ...
                throw new unieventsFrameException(BaseCode.USER_MOBILE_EMPTY);
            }
            ...
            if (StringUtil.isNotEmpty(errorCountStr) && Integer.parseInt(errorCountStr) >= ERROR_COUNT_THRESHOLD) {
                throw new unieventsFrameException(BaseCode.EMAIL_ERROR_COUNT_TOO_MANY);
            }
            ...
            if (Objects.isNull(userEmail)) {
                ...
                throw new unieventsFrameException(BaseCode.USER_EMAIL_NOT_EXIST);
            }
        ...
        if (Objects.isNull(user)) {
            throw new unieventsFrameException(BaseCode.NAME_PASSWORD_ERROR);
        }
    ...
    private GetChannelDataVo getChannelDataByClient(String code){
        ...
        throw new unieventsFrameException("没有找到ChannelData");
    }
    ...
    public void authentication(UserAuthenticationDto userAuthenticationDto){
        ...
        if (Objects.equals(user.getRelAuthenticationStatus(), BusinessStatus.YES.getCode())) {
            throw new unieventsFrameException(BaseCode.USER_AUTHENTICATION);
        }
        User updateUser = new User();
