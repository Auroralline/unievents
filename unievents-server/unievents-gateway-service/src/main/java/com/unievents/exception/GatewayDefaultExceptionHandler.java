...
public class GatewayDefaultExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        }else if (ex instanceof unieventsFrameException) {
            unieventsFrameException unieventsFrameException = (unieventsFrameException)ex;
            ApiResponse<String> apiResponse = ApiResponse.error(unieventsFrameException.getCode(), unieventsFrameException.getMessage());
