package com.unievents.filter;


import cn.hutool.core.collection.CollectionUtil;
import com.alibaba.fastjson.JSON;
import com.baidu.fsg.uid.UidGenerator;
import com.unievents.conf.RequestTemporaryWrapper;
...
import com.unievents.pro.limit.RateLimiter;
import com.unievents.pro.limit.RateLimiterProperty;
import com.unievents.property.GatewayProperty;
import com.unievents.service.ApiRestrictService;
import com.unievents.service.ChannelDataService;
import com.unievents.service.TokenService;
import com.unievents.threadlocal.BaseParameterHolder;
import com.unievents.util.RsaSignTool;
import com.unievents.util.RsaTool;
...
import static com.unievents.constant.Constant.GRAY_PARAMETER;
import static com.unievents.constant.Constant.TRACE_ID;
import static com.unievents.constant.GatewayConstant.BUSINESS_BODY;
import static com.unievents.constant.GatewayConstant.CODE;
import static com.unievents.constant.GatewayConstant.ENCRYPT;
import static com.unievents.constant.GatewayConstant.NO_VERIFY;
import static com.unievents.constant.GatewayConstant.REQUEST_BODY;
import static com.unievents.constant.GatewayConstant.TOKEN;
import static com.unievents.constant.GatewayConstant.USER_ID;
import static com.unievents.constant.GatewayConstant.V2;
import static com.unievents.constant.GatewayConstant.VERIFY_VALUE;
...
public class RequestValidationFilter implements GlobalFilter, Ordered {
    ...
    private Map<String,String> doExecute(String originalBody,ServerWebExchange exchange){
        ...
        if ((!allowNormalAccess) && (VERIFY_VALUE.equals(noVerify))) {
            throw new unieventsFrameException(BaseCode.ONLY_SIGNATURE_ACCESS_IS_ALLOWED);
        }
        if (checkParameter(originalBody,noVerify) && !skipCheckParameter(url)) {
            ...
            if (!checkFlag) {
                throw new unieventsFrameException(BaseCode.RSA_SIGN_ERROR);
            }
