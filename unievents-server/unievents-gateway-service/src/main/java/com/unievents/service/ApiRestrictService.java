...
import com.unievents.dto.ApiDataDto;
import com.unievents.enums.ApiRuleType;
import com.unievents.enums.BaseCode;
import com.unievents.enums.RuleTimeUnit;
import com.unievents.exception.unieventsFrameException;
import com.unievents.kafka.ApiDataMessageSend;
...
import com.unievents.service.lua.ApiRestrictCacheOperate;
import com.unievents.util.DateUtils;
import com.unievents.vo.DepthRuleVo;
    ...
    public void apiRestrict(String id, String url, ServerHttpRequest request) {
        if (checkApiRestrict(url)) {
            ...
            if (triggerResult == 1) {
                ...
                throw new unieventsFrameException(BaseCode.API_RULE_TRIGGER.getCode(),defaultMessage);
            }
        }
    }
