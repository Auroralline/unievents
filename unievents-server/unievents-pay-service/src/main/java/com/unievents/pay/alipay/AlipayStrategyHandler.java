package com.unievents.pay.alipay;
...
import com.unievents.enums.AlipayTradeStatus;
...
import com.unievents.pay.alipay.config.AlipayProperties;
...
public class AlipayStrategyHandler implements PayStrategyHandler {
    ...
    public PayResult pay(String outTradeNo, BigDecimal price, String subject, String notifyUrl, String returnUrl){
        try {
           ...
           throw new unieventsFrameException(BaseCode.PAY_ERROR);
        }
    }
    ...
    public RefundResult refund(String outTradeNo, BigDecimal price, String reason) {
        ...
        try {
            ...
            throw new unieventsFrameException(BaseCode.REFUND_ERROR);
        }
    }
    ...
    private Integer convertPayBillStatus(String tradeStatus){
        ...
        throw new unieventsFrameException(BaseCode.ALIPAY_TRADE_STATUS_NOT_EXIST);
    }
}
