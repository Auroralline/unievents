...
import com.unievents.dto.DepthRuleDto;
import com.unievents.dto.DepthRuleStatusDto;
import com.unievents.dto.DepthRuleUpdateDto;
import com.unievents.entity.DepthRule;
import com.unievents.enums.BaseCode;
import com.unievents.enums.RuleStatus;
import com.unievents.exception.unieventsFrameException;
import com.unievents.mapper.DepthRuleMapper;
    ...
    public void check(String startTimeWindow, String endTimeWindow){
        ...
        for (final DepthRule depthRule : depthRules) {
            ...
            if (checkStartLimitTimeResult || checkEndLimitTimeResult) {
                throw new unieventsFrameException(BaseCode.API_RULE_TIME_WINDOW_INTERSECT);
            }
        }
    }
