package com.unievents.filter.impl;
...
import static com.unievents.constant.Constant.GRAY_FLAG_FALSE;
import static com.unievents.constant.Constant.GRAY_FLAG_TRUE;
import static com.unievents.constant.Constant.GRAY_PARAMETER;
import static com.unievents.constant.Constant.SERVER_GRAY;
        ...
        try {
            ...
            if (!result && grayFromRequest.equalsIgnoreCase(GRAY_FLAG_TRUE)) {
                if (CollectionUtil.isEmpty(servers)) {
                    throw new unieventsFrameException(BaseCode.SERVER_LIST_NOT_EXIST);
                }
