...
public class DefaultExceptionHandler {
    ...
    * 业务异常
    * */
    @ExceptionHandler(value = unieventsFrameException.class)
    public ApiResponse<String> toolkitExceptionHandler(HttpServletRequest request, unieventsFrameException unieventsFrameException) {
        log.error("业务异常 method : {} url : {} query : {} ", request.getMethod(), getRequestUrl(request), getRequestQuery(request), unieventsFrameException);
        return ApiResponse.error(unieventsFrameException.getCode(), unieventsFrameException.getMessage());
    }
    /**
     * 参数验证异常
     */
